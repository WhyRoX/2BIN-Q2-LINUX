/// Solution implémentant les deux versions du programme:
/// ./ex1.4 fwrite --> pour tester la version utilisant la librairie standard
/// ./ex1.4 write --> pour tester la version utilisant les appels système
...
int main(int argc, char* argv[]) {
    ...
    {
        printf("Test fwrite ... cela est rapide car fwrite bufferise les I/O\n");
...
void usage (char* prog)
{
    fprintf(stderr,"Usage : time %s fwrite\n \ttime %s write\n", prog, prog);
    exit(EXIT_FAILURE);
}
